    ...
    try:
        ...
        with db_manager.get_db() as conn:
            ...
            def calculate_day_change(current_value, asset_type):
                ...
                logger.debug(f"  {asset_type}: current=¥{current_value:,.0f}, yesterday=¥{yesterday_value:,.0f}, change={day_change_rate:+.2f}%")
            ...
            if yesterday_data:
                ...
                logger.info(f"📈 Total Day Change: ¥{total_day_change:,.0f} ({total_day_change_rate:+.2f}%)")
